...
import cl.buildersoft.albizia.business.service.impl.AgreementServiceImpl;
...
import cl.buildersoft.timectrl.business.beans.Profile;

@WebServlet("/servlet/config/employee/ContractualInfo")
public class ContractualInfo extends BSHttpServlet_ {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		forward(request, response, "/WEB-INF/jsp/config/employee/contractual-info.jsp");
