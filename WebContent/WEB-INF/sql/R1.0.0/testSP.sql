...
begin
	...
	IF (NOT EXISTS(select cId from tEnterprise where cRUT='1-9')) THEN
		...
		VALUES('1-9', 'Buildersoft SpA.', 'Juan Perez', '1-9', 'Servicios profesionales', 'Avenida X, numero 88', 3, '2345678', 1, 0.0231, 1);
	END IF;
	...
	IF (NOT EXISTS(select cId from tEmployee where cRut='10809246-7')) THEN
		INSERT INTO tEmployee(cRut,		cName,		cBirthDate,		cAddress,						cGenere,	cComuna,	cCountry,	cMaritalStatus,	cPhone, cMovil, cEmail) 
